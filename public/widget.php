...
if ( ! class_exists( 'Broke_Widget' ) ) {

  class Broke_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'broke-template';
  	...
  	public function widget( $args, $instance ) {
  		...
  		$widget_string .= broke_shortcode( array( 'id' => $instance['template_id'] ), '', NULL );
...
add_action( 'widgets_init', function() { register_widget("Broke_Widget"); } );
